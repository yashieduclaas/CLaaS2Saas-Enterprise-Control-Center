...
const useStyles = makeStyles({
  ...
  searchRow: {
    ...
    gap: '8px', // Consistent spacing between icon and input
    backgroundColor: '#f8f9fa', // Lighter background for better contrast
    borderRadius: '8px',
    border: '1px solid #e6e3de', // Light border for better contrast
    paddingLeft: '12px', // Consistent horizontal padding
    paddingRight: '12px', // Consistent horizontal padding
